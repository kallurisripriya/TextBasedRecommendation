        	...
        	<table width="990px" border="0" align="center">
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <h1>WELCOME TO Student HOME</h1>  <p align="right"><a href="UserLogin.jsp" class="btn" >Logout</a></p>
                        </td>
                    </tr>
            <tr>
...
%>
   <tr>
       <td style="height:65px;font-size:28px;"><a href="subjectinfo_1.jsp?subject=<%=subject%>&top1=<%=top1%>&top2=<%=top2%>&top3=<%=top3%>&top4=<%=top4%>&top5=<%=top5%>&tag=<%=tag%>&body=<%=body%>"style="font-weight:bold;"><%=rs.getString("subject")%></a></td>

          
</tr>
  
<a href="userhome_1.jsp"></a>
        <%
